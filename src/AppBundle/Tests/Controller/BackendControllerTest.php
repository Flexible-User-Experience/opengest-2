...
class BackendControllerTest extends AbstractBaseTest
{
    ...
    public function provideSuccessfulUrls()
    {
        return array(
            ...
            array('/admin/administracio/province/list'),
            array('/admin/administracio/province/create'),
            array('/admin/administracio/province/1/edit'),
            array('/admin/administracio/province/1/delete'),
