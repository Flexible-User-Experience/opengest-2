...
class BackendControllerTest extends AbstractBaseTest
{
    ...
    public function provideSuccessfulUrls()
    {
        return array(
            ...
            array('/admin/administracio/operador/tipus-absencia/list'),
            array('/admin/administracio/operador/tipus-absencia/create'),
            array('/admin/administracio/operador/tipus-absencia/1/edit'),
            array('/admin/operaris/operador/absencia/list'),
            array('/admin/operaris/operador/absencia/create'),
            array('/admin/operaris/operador/absencia/1/edit'),
