...
class BackendControllerTest extends AbstractBaseTest
{
    ...
    public function provideSuccessfulUrls()
    {
        return array(
            ...
            array('/admin/administracio/tipus-revisio/list'),
            array('/admin/administracio/tipus-revisio/create'),
            array('/admin/administracio/tipus-revisio/1/edit'),
            array('/admin/administracio/revisio/list'),
            array('/admin/administracio/revisio/create'),
            array('/admin/administracio/revisio/1/edit'),
